...
gmm_params = {
    "K": 5,                      # Even more clusters → maximum ambiguity
    "d": 800,                   # High dimensional: p = 800 >> n = 500
    "mean_scale": 0.1,           # Very small scale → extreme overlap between clusters
    "temperature": 0.1,          # Very low temperature → extremely soft boundaries
    "cluster_spread": 3.0,       # Very high spread → maximum overlap
    "response_noise": 2.5,       # Extremely high noise level
    "deterministic_margin": 0.01, # Tiny margin → almost everything is ambiguous
}
